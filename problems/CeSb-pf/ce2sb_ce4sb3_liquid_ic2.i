...
[ICs]
  [./eta1]
    variable = eta1
    type = FunctionIC
    function = '1*if((x>=30&x<=40&y>=20&y<=40),1,0)'
  [../]
  [./eta2]
    variable = eta2
    type = FunctionIC
    function = '1*if((x>=30&x<=40&y>=0&y<20),1,0)'
  [../]
  [./eta3]
    variable = eta3
    type = FunctionIC
    function = '1*if((x>=0&x<30&y>=0&y<=40),1,0)'
  [../]
  [./c]
    variable = c
    type = FunctionIC
    function = '0.6667*if((x>=30&x<=40&y>=20&y<=40),1,0)+0.5714*if((x>=30&x<=40&y>=0&y<20),1,0)+0.6*if((x>=0&x<30&y>=0&y<=40),1,0)'
  [../]
[]
